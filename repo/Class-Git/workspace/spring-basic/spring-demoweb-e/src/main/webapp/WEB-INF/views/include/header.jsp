...
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
		...
		<div id="header">
            ...
            <div class="title">
                <a href="/spring-demoweb-e/home.action">GREEN WEBSITE</a>
            </div>
            <div class="links">
                      
            <c:choose>
            <c:when test="${ empty loginuser }">
            	<a href="/spring-demoweb-e/account/login.action">로그인</a>
                <a href="/spring-demoweb-e/account/register.action">회원가입</a>
            </c:when>
            <c:otherwise>
            	${ loginuser.memberId }님 환영합니다.
            	<a href="/spring-demoweb-e/account/logout.action">로그아웃</a>
            </c:otherwise>
            </c:choose>
            </div>
        </div>
