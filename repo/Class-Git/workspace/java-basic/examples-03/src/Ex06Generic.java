...
public class Ex06Generic {
	...
	public static void main(String[] args) {
		...
		obj1.v = 10;	// Object 자료형이기 때문에 모든 종류의 데이터를 저장
		TheObject obj2 = new TheObject();
		obj2.v = "홍길동";	// Object 자료형이기 때문에 모든 종류의 데이터를 저장
		
		int x = (int)obj1.v;	// Object 자료형의 데이터는 읽을 때 일반적으로 형변환 필요
		// int x3 = (int)obj2.v;	// 잘못된 형변환 프로그램을 멈추는 효과
		if (obj2.v instanceof Integer) { // 안전한 형변환
			int x2 = (int)obj2.v;
		}
